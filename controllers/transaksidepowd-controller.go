...
func Transdpwdhome(c *fiber.Ctx) error {
	...
	jsonparser.ArrayEach(record_RD, func(value []byte, dataType jsonparser.ValueType, offset int, err error) {
		...
		transdpwd_notebank, _ := jsonparser.GetString(value, "transdpwd_notebank")
		...
		obj.Transdpwd_notebank = transdpwd_notebank
		obj.Transdpwd_amount = float32(transdpwd_amount)
		obj.Transdpwd_before = float32(transdpwd_before)
		obj.Transdpwd_after = float32(transdpwd_after)
